...
(Full implementation [here](https://github.com/HenryDashwood/ai-notes/blob/master/nbs/tokenisation/sentencepiece.ipynb))

### Dummy whitespace tokens

In my [byte pair encoding from scratch](https://github.com/HenryDashwood/ai-notes/blob/master/nbs/tokenisation/byte_pair_encoding_from_scratch.ipynb) notebook I used a regex to split text into chunks. Merges can can never take place across those hard world boundaries.
